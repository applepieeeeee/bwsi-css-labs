...
def main():
    ...
    name = "Clair" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")

    print("Hey, I'm Clair, a sophomore from Massachusetts. A fun fact about me is that I enjoy Model UN!")
